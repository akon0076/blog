...
const serverRender = async (ctx, config) => {
    ...
    return (React.createElement(react_router_dom_1.StaticRouter, null,
        React.createElement(Context.Provider, { value: { state: combineData } },
            React.createElement(index_tsx_1.default, { ctx: ctx, config: config, staticList: staticList }, isCsr ? React.createElement(React.Fragment, null) : React.createElement(Component, null)))));
};
