...
program
    ...
    .description(`Execute your function in a local environment which replicates the live environment
...
parameter.`)
    ...
    .option('-c, --config <ide/debugger>', 'Select which IDE to use when debugging and output related debug config tips for the IDE. Options：\'vscode\', \'pycharm\'')
    .option('-e, --event <event>', `Support Event data(strings) or a file containing event data passed to the function during invocation.`)
    ...
    .option('-d, --debug-port <port>', `Specify the sandboxed container starting in debug mode, and exposing this port on localhost
  `)
