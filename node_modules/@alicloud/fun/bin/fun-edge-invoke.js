...
program
    ...
    .description(`Execute your function in a local Link IoT Edge environment which replicates the release
  ...
  the -e (--event) parameter.`)
    ...
    .option('--debug', `Specify your function executes in debug mode, and listens
                             on port 5700 at localhost for debuggers to connect`)
    .option('-e, --event <path>', `A file containing event data passed to the function during
                             invoke, If this option is not specified, it defaults to
                             reading event from stdin`)
    .option('-c, --config <ide/debugger>', `Output configurations for the specified ide/debugger, where
                             the ide/debugger can currently only be vscode`)
    .option('--output-debugger-configs', `Output configurations for all debuggers. It will override
