...
class FunctionComputeClient {
    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            const params = JSON.stringify(this._buildParams({
                UserName: 'admin',
                Password: 'admin1234'
            }));
            const options = {
     ...
     * @returns {Promise}
     */
    deploy({ functionId, serviceName, functionName, handler, runtime, timeout, memory, codeDir, codeChecksum = undefined, accountId = undefined, region = undefined, pinned = false, envVars = undefined, debugPort = undefined }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cookie = yield this._login();
            const options = {
                method: 'POST',
                host: 'localhost',
                port: '9999',
     ...
     * @returns {Promise}
     */
    invoke({ functionId, functionName, serviceName, accountId = undefined, region = undefined, invokerContext = '', event = '{}', invocationType = 'Sync' }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!functionId && (!serviceName || !functionName)) {
                throw new Error(`Neither Function id nor serviceName/functionName is provided.`);
            }
            if (invocationType !== 'Sync' && invocationType !== 'Async') {
                throw new Error(`Incorrect invocationType ${invocationType}. It should be 'Sync' or 'Async'`);
            }
