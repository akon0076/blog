...
exports.CUSTOM_TAGS = [
    ...
    },
    {
        ...
        description: 'The intrinsic function Fn::Join appends a set of values into a single value, separated by the specified delimiter.'
    },
    {
        tag: '!Select',
        kind: 'sequence',
    ...
    },
    {
        ...
        kind: 'sequence',
        propertyName: 'Fn::And',
        description: 'Returns true if all the specified conditions evaluate to true, or returns false if any one of the conditions evaluates to false.'
    },
    {
        tag: '!Or',
        kind: 'sequence',
        propertyName: 'Fn::Or',
        description: 'Returns true if any one of the specified conditions evaluate to true, or returns false if all of the conditions evaluates to false.'
    },
    {
        tag: '!Not',
        kind: 'sequence',
        propertyName: 'Fn::Not',
        description: 'Returns true for a condition that evaluates to false or returns false for a condition that evaluates to true.'
    },
    {
        tag: '!If',
        kind: 'sequence',
        propertyName: 'Fn::If',
        description: 'Returns one value if the specified condition evaluates to true and another value if the specified condition evaluates to false.'
    },
    {
        tag: '!ListMerge',
        kind: 'sequence',
...
exports.CUSTOM_TAGS_BY_PROPERTY_NAME = _.keyBy(exports.CUSTOM_TAGS, 'propertyName');
