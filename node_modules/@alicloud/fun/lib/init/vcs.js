...
function downloadRepoZip(repoType, repoUrl, repoDir, outputDir, checkout) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield httpx.request(getRepoZipUrl(repoUrl), { timeout: 36000000, method: 'GET' }); // 10 hours
        ...
        return yield new Promise((resolve, reject) => response.pipe(unzipper.Extract({ path: outputDir })).on('error', err => {
            if (bar) {
                bar.interrupt(err);
            }
            reject(err);
...
function clone(repoUrl, cloneToDir = '.', checkout) {
    return __awaiter(this, void 0, void 0, function* () {
        debug('clone to dir: %s', cloneToDir);
        cloneToDir = path.resolve(cloneToDir);
        yield fs.ensureDir(cloneToDir);
        ...
        if (isVCSInstalled(repoType)) {
            ...
            if (repoType === 'git') {
                ...
                yield downloadRepoZip(repo, repoUrl, repoDir, outputDir, checkout);
            }
            else {
