...
function funfileToDockerfile(funfilePath, runtime, serviceName, functionName) {
    return __awaiter(this, void 0, void 0, function* () {
        const content = yield fs.readFile(funfilePath, 'utf8');
...
If you have a requirement, you can submit the issue at https://github.com/alibaba/funcraft/issues.`);
            ...
            if (ins.toUpperCase() === 'RUNTIME') {
                ...
                const imageName = yield dockerOpts.resolveRuntimeToDockerImage(runtimeOfFunfile, true);
                dockerfile.push('FROM ' + (yield dockerOpts.resolveImageNameForPull(imageName)) + ` as ${runtimeOfFunfile}`);
            }
            else {
